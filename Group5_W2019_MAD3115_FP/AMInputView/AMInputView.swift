...
@IBDesignable class AMInputView: UIView,UITextFieldDelegate {
    ...
    func setViewExpandMode(expand:Bool){
        if expand{
            backViewHeightExpandConstraint.priority = UILayoutPriority(rawValue: 500)
            labelViewHTopExpandConstraint.priority = UILayoutPriority(rawValue: 500)
            labelViewRightExpandConstraint.priority = UILayoutPriority(rawValue: 500)
            labelViewLeftExpandConstraint.priority = UILayoutPriority(rawValue: 999)
        }else{
            backViewHeightExpandConstraint.priority = UILayoutPriority(rawValue: 200)
            labelViewHTopExpandConstraint.priority = UILayoutPriority(rawValue: 200)
            labelViewRightExpandConstraint.priority = UILayoutPriority(rawValue: 300)
            labelViewLeftExpandConstraint.priority = UILayoutPriority(rawValue: 300)
        }
